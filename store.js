...
function criarBalao() {
  ...
  logo.src =
    "https://albert-mkt.s3.amazonaws.com/albert+muito+ale%CC%81m+de+cashback.png";
  logo.alt = "Logo";
  logo.style.height = "70px";
  logo.style.display = "block"; // Para centralizar horizontalmente
  logo.style.margin = "0 auto"; // Para centralizar horizontalmente
...
`;
  ...
  balao.style.textAlign = "center"; // Para centralizar o botão horizontalmente

  balao.appendChild(botao);

  // Estilos CSS para o balão
  balao.style.position = "fixed";
  balao.style.height = "250px"; // Ajustado para acomodar o botão
